...
import { MemoryRuntimeDebug } from '@proj-airi/stage-ui/components'
  ...
  <div h="<md:full" flex gap-2 class="ph-no-capture">
    <div :class="['w-full flex flex-col gap-2']">
      ...
      >
        ...
        <div :class="['flex items-center justify-between border-t border-primary-200/20 px-3 py-2 dark:border-primary-400/20']">
          ...
          <button
            :class="[
              ...
              messageInput.trim()
                ...
                : 'bg-neutral-200/70 text-neutral-400 dark:bg-neutral-800/80 dark:text-neutral-500',
            ]"
